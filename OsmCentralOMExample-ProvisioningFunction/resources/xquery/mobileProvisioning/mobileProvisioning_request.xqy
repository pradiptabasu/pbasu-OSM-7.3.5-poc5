...
<mobileOrderActivation xmlns="http://xmlns.oracle.com/communications/sce/dictionary/OsmCentralOMExample/mobile"
 ...
 xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
     <order>
        ...
        <IMSI>TODO - Technical Catalog</IMSI>
        <MSISDN>{$serviceId}</MSISDN>
        <HLR>TODO - Technical Catalog</HLR>
        <PRE>{if (exists($preLine)) then ('PRE') else ('POST')}</PRE>
        <KI>TODO - Technical Catalog</KI>
    </order>
</mobileOrderActivation>
)