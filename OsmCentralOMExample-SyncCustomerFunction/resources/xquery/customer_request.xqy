...
let $serviceLine := $order/oms:_root/oms:ControlData/oms:Functions/oms:SyncCustomerFunction/oms:orderItem[1]
...
log:info($log,fn:concat('cdi request[',/oms:GetOrder.Response/oms:OrderID,'] count[',count(/oms:GetOrder.Response/oms:_root/oms:data),']')),
<order xmlns="http://xmlns.oracle.com/communications/sce/dictionary/OsmCentralOMExample/customer"
