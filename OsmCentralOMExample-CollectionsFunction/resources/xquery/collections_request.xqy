...
let $serviceLine := $order/oms:_root/oms:ControlData/oms:Functions/oms:CollectionsFunction/oms:orderItem[1]
...
log:info($log,fn:concat('collections request[',/oms:GetOrder.Response/oms:OrderID,'] count[',count(/oms:GetOrder.Response/oms:_root/oms:data),']')),
<order xmlns="http://xmlns.oracle.com/communications/sce/dictionary/OsmCentralOMExample/collections"
